...
class rent : public customer // inhereted class from customer class
{
    ...
    do
    {
        cout <<"\t\t\t\tPlease Select a Car\n\n"<<endl; //giving user a choice to select among three different models
        cout<<"\t\t\t\tEnter 'A' for Tesla 2011.\n"<<endl;
        cout<<"\t\t\t\tEnter 'B' for Hyundai 2015.\n"<<endl;
        cout<<"\t\t\t\tEnter 'C' for Ford 2017.\n"<<endl;
        cout<<"\t\t\t\tEnter 'D' for AUDI R8.\n"<<endl;
        cout<<endl;
...
if(carmodel=="D")
  {
  	system("CLS");
		...
		cout<<"You have choosed AUDI R8"<<endl;
		 ifstream inB("D.txt"); //displaying details of model D
         char str[200];
         while(inB) {
         inB.getline(str, 200);  
         if(inB) cout << str << endl;
...
void showrent()
    ...
    cout << "\t\t	///////////////////////////////////////////////////////////"<<endl;
    cout << "\t\t\n\n DO YOU WISH TO PRINT INVOICE (y/n)";  
    cin  >> choice;
    if(choice=='y')
    {
		cout<<"\n\nPRINTING...\n\n\n";
